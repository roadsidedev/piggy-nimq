...
const content = [
  ...
  '      VF,',
  '      [_admin.address, _operator.address, assetAddr, maAddr, 5000, 1300000000000000000n],',
  ...
  '          kind: "uups",',
  '          call: { fn: "initialize", args: [admin.address, operator.address, aAddr, addr, 5000, 1300000000000000000n] },',
  '        })',
